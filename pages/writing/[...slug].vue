  ...
  <div class="p-8">
    <ContentDoc v-slot="{ doc }">
      ...
      <section class="flex gap-12 flex-col lg:flex-row mb-4">
        <article
          class="prose prose-invert lg:prose-lg prose-headings:font-bold lg:flex-1 lg:max-w-none"
        >
          ...
          <p
            ...
            v-if="
              doc.canonical_url && !doc.canonical_url.includes('timbenniks.dev')
            "
          >
        ...
        <aside class="lg:w-96 lg:flex-shrink-0">
