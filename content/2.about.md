...
#ctas
:cta{text="Find Speaker information here" url="/presskit"}
:cta{text="My setup" url="/uses"}

#image
![Tim Benniks in his countryside office in August 2023](/website/tim_augmented.png){fetchPriority="high" fit="thumbnail" height="858" loading="eager" provider="cloudinaryNative" sizes="sm:100vw md:1440px" width="2000"}
::
...
#sideb
  :::media
  #media
  ![Tim at Vue.js Amsterdam 2024](/Tim/tim-talk.png){fit="thumbnail" height="2103" loading="lazy" provider="cloudinaryNative" sizes="sm:100vw md:40vw" width="1550"}

  #caption
  Tim at Vue.js Amsterdam 2024
  :::
::
...
#ctas
:cta{text="See all conference vlogs here" url="/videos/mp"}
::
...
#ctas
:cta{text="Find my conference schedule here" url="/speaking"}
...
#sidea
  ...
  Reach out to [timbenniks.dev@gmail.com](mailto:timbenniks.dev@gmail.com) or find Tim on [Linkedin](https://linkedin.com/in/timbenniks) or [Twitter](https://x.com/timbenniks).
  :::
