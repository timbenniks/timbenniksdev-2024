...
tags: [cms, architecture, web development, api, Development, performance, Tools]
collection_id: 22300
...
head:
  meta:
    - property: twitter:image
      content: http://res.cloudinary.com/dwfcofnrd/image/fetch/f_auto,q_auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fr4ykeb6acv0q288ygpaj.png
    - property: twitter:title
      content: This is headless 2.0
    - property: twitter:description
      content: That’s a bold title, but it’s high time to change how we work with headless technology. I wrote about...
    - property: keywords
      content: cms, architecture, web development, api, Development, performance, Tools
