...
faqs:
  ...
  - question: Does this mean companies need fewer product managers and other roles?
...
_More artifacts do not equal more progress._

## The uncomfortable truth

This is what many organizations are avoiding: AI doesn't reward activity. It rewards _execution density_. Roles where value is created by turning intent into shipped artifacts scale dramatically. Roles where value is created through coordination, signaling, or abstraction? They don't scale linearly at all.
...
Meanwhile, AI exposes how much organizational work existed to _compensate_ for slow shipping. Layers of planning, handoffs, decks, and rituals made sense when shipping was expensive. When shipping becomes cheap, those layers start to look like friction instead of leverage.

## The real shift

This is why the real shift isn't fewer developers. It's _fewer layers between a problem and code_.
